...
export default function ChatClipboardDialog({ open, onClose, data, onUpload }: { open: boolean, onClose: () => void, data: any, onUpload: () => void }) {
    ...
    >
      ...
      >
        <FileThumbnail
          ...
          imgSx={{ borderRadius: 1, width: '240px', height: '240px' }} tooltip={false} onDownload={() => {}} sx={undefined} />
