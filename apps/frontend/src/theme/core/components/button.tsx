  ...
  base: [
    {
      ...
      style: ({ theme }) => ({
        ...
        // [`& .${LoadingButtonClassKey.loadingIndicatorStart}`]: { left: 14 },
        // [`& .${LoadingButtonClassKey.loadingIndicatorEnd}`]: { right: 14 },
        // [`&.${buttonClasses.sizeSmall}`]: {
        //   [`& .${LoadingButtonClassKey.loadingIndicatorStart}`]: { left: 10 },
        //   [`& .${LoadingButtonClassKey.loadingIndicatorEnd}`]: { right: 10 },
        // },
      }),
    },
  ],
